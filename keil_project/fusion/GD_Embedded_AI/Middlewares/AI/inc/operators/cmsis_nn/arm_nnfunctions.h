...
arm_cmsis_nn_status arm_lstm_unidirectional_s8(const int8_t *input,
                                               ...
                                               int need_clear_status);
                                               
arm_cmsis_nn_status arm_lstm_bidirectional_s8(const int8_t *input,
                                              int8_t *output,
                                              const cmsis_nn_lstm_params *params_fwd,   /* Forward LSTM parameters */
                                              const cmsis_nn_lstm_params *params_bwd,   /* Backward LSTM parameters */
                                              cmsis_nn_lstm_context *buffers_fwd,       /* Forward LSTM buffer */
                                              cmsis_nn_lstm_context *buffers_bwd,       /* Backward LSTM buffer */
                                              int8_t *output_bwd,                        /* Buffer to store the reversed sequence */
                                              int need_clear_status);
                                              
/* come form cmsis_nn600  */                                            
