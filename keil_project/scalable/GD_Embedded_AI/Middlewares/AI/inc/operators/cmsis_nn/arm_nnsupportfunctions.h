...
/*  cmsis nn 6.0.0 for arm_nn_mat_mult_kernel_s8_s16  */                                              
int8_t *arm_nn_mat_mult_kernel_s8_s16_cmsis600(const int8_t *input_a,
                                      const int16_t *input_b,
                                      const uint16_t output_ch,
                                      const int32_t *out_shift,
                                      const int32_t *out_mult,
...
/*  cmsis nn 6.0.0 for groupConv  */                                      
arm_cmsis_nn_status arm_convolve_s8_with_group(const cmsis_nn_context *ctx,
                                    const cmsis_nn_conv_params *conv_params,
                                    const cmsis_nn_per_channel_quant_params *quant_params,
 ...
 *
 */
__STATIC_FORCEINLINE int32_t arm_nn_requantize_high(const int32_t val, const int32_t multiplier, const int32_t shift)
{
...
arm_cmsis_nn_status arm_nn_vec_mat_mult_t_s8_cmsis600(const int8_t *lhs,
                                             const int8_t *rhs,
...
arm_cmsis_nn_status arm_nn_mat_mult_nt_t_s8_2022(const q7_t *lhs,
                                   const q7_t *rhs,
                                   const q31_t *bias,
                                   q7_t *dst,
                                   const int32_t *dst_multipliers,
